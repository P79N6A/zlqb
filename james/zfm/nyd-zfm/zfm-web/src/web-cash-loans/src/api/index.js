...
export default {
    ...
    getReadyDistributionList(data, params) { //贷中待分配列表
        return Axios.post("loan/postlending/getReadyDistributionList",  data, {
            params: params
        });
    },
    getReminderDistributionList(data, params) { //贷中提醒中列表
        return Axios.post("/loan/postlending/getReminderDistributionList", data, {
            params: params
        });
    },
    getCreditTrialUsersList(data, params) { //提醒人员列表
        return Axios.post("/loan/postlending/getCreditTrialUsersList",  queryString.stringify(data), {
            params: params
        });
    },
    doDistribution(data, params) { //贷中分配
        return Axios.post("/loan/postlending/doDistribution", data, {
            params: params
        });
    },
    addRemindMsg(data, params) { //添加提醒流水
        return Axios.post("/api/remindFlow/addRemindMsg", data, {
            params: params
        });
    },
    queryRemindMsgList(data, params) { //查询提醒流水
        return Axios.post("/api/remindFlow/queryRemindMsgList", queryString.stringify(data), {
            params: params
        });
    },
    // 贷后管理
    LoanOverdueList(data, params) { //贷后管理-全部订单
        return Axios.post("/loan/urge/overdueList",  data, {
            params: params
        });
    },
    
    // 08-02 
    emergencyContact(data, params) { //紧急联系人
        return Axios.post("/collectionRecord/emergencyContact",  data, {
            params: params
        });
    },
    saveCollection(data, params) { //添加催记
        return Axios.post("/collectionRecord/saveCollection",  data, {
            params: params
        });
    },
    collectionList(data, params) { //催收记录表
        return Axios.post("/collectionRecord/collectionList",  data, {
            params: params
        });
    },
    getBillRepayList(data, params) { //还款流水
        return Axios.post("/loan/postlending/getBillRepayList",  data, {
            params: params
        });
    }, 
    
    LoanDoDistribution(data, params) { // 分配
        return Axios.post("/loan/urge/doDistribution",  data, {
            params: params
        });
    },
    LoangetCreditTrialUsersList(data, params) { // 获取信审专员列表
        return Axios.post("/loan/urge/getCreditTrialUsersList",  queryString.stringify(data), {
            params: params
        });
    }, 
    LoanOverdueAssignList(data, params) { // 贷后订单提醒
        return Axios.post("/loan/urge/overdueAssignList",  data, {
            params: params
        });
    }, 
