...
<head>
	...
	* {
	...
	.gefang{ display:inline-block; width:180px; margin-right:20px;margin-left:5px;}
	.fr{ float:right;padding-top:150px;}
	</style>
</head>
  <body>
     <div class="art_wrap">
...
<table style="width:100%;margin: 0px auto;text-align:center  ; font-size:12px; border-collapse: collapse; border: 1px solid rgb(0, 0, 0); width:100%; " class="tb_ccc0">
    <tr>
        ...
        <td style="border: 1px solid rgb(0, 0, 0);text-align:left;">（小写）:${po.lowerLoanMoney}</td> 
        <td style="border: 1px solid rgb(0, 0, 0);text-align:left;" colspan="4">（大写）:${po.capitalLoanMoney}</td> 
    </tr>
    <tr>
        ...
        <td style="border: 1px solid rgb(0, 0, 0);text-align:left;" colspan="2">${po.totalMoney}</td>  
    </tr>
    <tr>
        ...
        <span class="underline">${po.startYear}</span>年<span class="underline">${po.startMonth}</span>月<span class="underline">${po.startDay}</span>日至
        <span class="underline">${po.endYear}</span>年<span class="underline">${po.endMonth}</span>月<span class="underline">${po.endDay}</span>日
        </td> 
    </tr>
    <tr>
        <td style="border: 1px solid rgb(0, 0, 0);" rowspan="2">收款/还款账户</td> 
        <td style="border: 1px solid rgb(0, 0, 0);">开户行</td> 
        <td style="border: 1px solid rgb(0, 0, 0);text-align:left;" colspan="4">${po.bankName}</td> 
    </tr>
    <tr>
...
<p class="indent2">3.3 如乙方提前还款的或因违约而产生逾期利息、违约金等，乙方已委托并授权甲方指定的支付机构将相应金额从上述还款账户中扣划给甲方；
</p>
...
<p class="indent2">如乙方的还款金额不足以清偿全部到期本息及逾期利息等其他债务的，则乙方的还款首先用于清偿乙方须承担的各项费用（包括不限于逾期利息、
违约金等），剩余款项按照先还利息后还本金的顺序清偿。</p>
...
<p class="indent2">6.3 乙方在签署和履行本合同过程中向甲方提供的全部文件、资料及信息是真实、合法、完整和有效的，未向甲方虚构、隐瞒、伪造及遗漏可能
影响其还款能力的任何信息；</p>
...
<p class="indent2">6.8 为甲方贷款审查及债权实现之目的，乙方同意并授权甲方及甲方委托的第三方可向不动产登记中心、电信业务部门等相关机关（或第三方机构
）查询乙方个人有关信息（包括但不限于家庭住址、通讯电话、工作单位、财产情况等）。</p>
...
<p class="indent2">7.2 出现下列任一情形，自违约出现之日甲方有权按照【合同金额*（0.05）%/天】的标准向乙方收取违约金，直至乙方正常履行义务之日止：
</p>
<p class="indent2">7.2.1 乙方未按本合同约定的期限归还贷款本息的；</p>
<p class="indent2">7.2.2 乙方未按本合同约定的用途使用贷款的；</p>
<p class="indent2">7.3 因乙方违约而致甲方为维护和实现债权发生的损失，包括但不限于仲裁/诉讼费用、调查费用、律师费用、评估费用、公告费用、差旅费用、
上门催收费用（200元/次）等均由乙方承担。</p>
<p class="titL2">第八条 债权转让</p>
<p class="indent2">各方同意并确认，若甲方转让其债权的，可通过包括但不限于邮寄送达、电子邮件、手机短信等方式及时通知乙方。该通知自甲方发送后即视为送
达，相关债权转让即对乙方发生法律效力。乙方应向债权受让人继续履行本协议的后续还款义务。</p>
<p class="titL2">第九条 通知</p>
<p class="indent2">9.1 双方确认以合同中预留的电子邮箱，作为双方之间往来以及仲裁机构仲裁和法院执行时的相关资料、通知、法律文书（包括裁决书）的送达
地址,并以预留的手机号码为短信的通知号码;</p>
<p class="indent2">9.2 双方确认任何一方向对方、仲裁机构或者法院执行机构向双方发出的任何通知，以电子邮件或者短信方式发出，发送一方正确填写接受预留
的电子邮箱或手机号码即视为送达;</p>
<p class="indent2">9.3 任何一方送达地址或电子邮箱、通讯号码发生变化时，应在该变更发生后的3日内以书面形式通知另一方，如一方需变更邮箱或者手机号码，
应当与对方协商一致。如一方当事人变更邮箱或者手机号码未书面告知对方，任何一方当事人、仲裁机构或者执行法院向上述原邮箱或者原手机号码，发送法律文件被邮件系统
或者短信系统退回的，均视为已经完成送达;</p>
<p class="indent2">9.4 甲乙双方一致同意，若因履行本合同产生纠纷而发生诉讼/仲裁/执行的，本合同约定的送达地址将作为人民法院或仲裁机构法律文书的送达
地址。</p>
...
<p class="indent2">10.2 双方同意由仲裁院采用书面审理的方式通过网络仲裁方式解决纠纷。届时仲裁院将通过电子邮件或者短信等电子方式通知被申请人案件受理
情况以及答辩要求。被申请人一方应当在收到仲裁院立案通知邮件三日内通过邮件方式进行答辩、提交相关证据、选择仲裁员，逾期不答辩、不提交相关证据、选择仲裁员的，
将由仲裁院指定仲裁员依法作出裁决；</p>
<p class="indent2">10.3 双方同意本案裁决书可不写明事实和理由，由仲裁庭根据相关证据直接作出仲裁裁决，并同意由仲裁院通过电子邮件方式送达裁决书；
</p>
<p class="indent2">10.4 双方同意仲裁院可以其认为的适当方式公布裁决书。</p>
<p class="titL2">第十一条 其他</p>
<p class="indent2">11.1 乙方在申请贷款成功前已对本协议各条款进行确认，自甲乙双方达成一致时成立，自甲方或甲方委托的第三方将出借款项支付到乙方收款账户
时生效；</p>
<p class="indent2">11.2 本协议的任何修改、补充、变更均需以书面(含电子协议)形式签订；</p>
<p class="indent2">11.3 乙方已仔细阅读本合同所有条款，甲方已依法向乙方充分提示了全部条款，特别是限制其责任的条款，并应乙方要求对全部条款的内容和法律
含义作出明确说明，乙方已知悉并理解本合同所有内容及法律效力且无异议。</p>
<p class="indent2">11.4 本合同正本一式贰份，签约双方各执一份，均具同等法律效力。  </p><br/>
<p class="indent2 gefang">
<img src="${po.writeSignImg}" class="image" style="height: 140px;"/></p>
