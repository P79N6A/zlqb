...
public class ArithUtil {
	...
	public static double div(double v1,double v2,int scale){
      ...
      public static String divPercentage(double v1,double v2){
		...
		BigDecimal b2 = BigDecimal.valueOf(v2);
		if(b2.compareTo(big0) == 0){return "NaN";}
      ...
      public static String divPe(double v1,double v2){
  		...
  		BigDecimal c = b1.divide(b2,4,BigDecimal.ROUND_HALF_UP);
	...
	*/
	...
	public static String formatValue(String value) {
		if (!ChkUtil.isEmpty(value)) {
			DecimalFormat df = new DecimalFormat("#0.00");
			value = df.format(new Double(value));
		}
		return value;
	}
}