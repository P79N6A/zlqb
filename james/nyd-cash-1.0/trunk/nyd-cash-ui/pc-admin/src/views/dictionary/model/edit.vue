  ...
  <div class="form-container">
    <div class="page-bread">
      <el-breadcrumb separator="/">
        <el-breadcrumb-item :to="{ path: '/dictionary/model' }">工厂管理</el-breadcrumb-item>
    ...
    <div class="form-content">
      <el-form :model="form" :rules="rules" ref="form" label-width="120px" class="form-wraper">
        <el-form-item label="型号编号" v-if="this.$route.params.id">
        ...
        <el-form-item label="规格" prop="specId">
          <el-input v-model="form.specId"></el-input>
        </el-form-item>
