  ...
  <div class="grid-container">
    ...
    <div class="grid-content">
      <el-table :data="tableData" v-loading.body="loading" stripe style="width: 100%">
        ...
        <el-table-column prop="seriesId" label="系列ID" width="150"/>
        <el-table-column prop="specId" label="规格ID" width="150"/>
  ...
  export default {
    ...
    methods: {
      loadData: function () {
        ...
        Utils.ajax(Api.dictionary.model.list, params, (success) => {
      ...
      add: function () {
        ...
        this.$router.push({path: '/dictionary/model/add'});
      },
      edite: function (row) {
        sessionStorage.setItem("_factory",JSON.stringify(row));
        this.$router.push({path: '/dictionary/model/edit/' + row.id});
      },
