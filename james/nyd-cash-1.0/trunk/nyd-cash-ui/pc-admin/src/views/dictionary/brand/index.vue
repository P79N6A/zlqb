  ...
  <div class="grid-container">
    ...
    <div class="grid-content">
      <el-table :data="tableData" v-loading.body="loading" stripe style="width: 100%">
        ...
        <el-table-column prop="rid" label="所属公司" width="150"/>
        <el-table-column prop="name" label="名称" width="150"/>
        <el-table-column prop="logo" label="logo" width="150"/>
        <el-table-column prop="url" label="电话" width="150"/>
        <el-table-column prop="weight" label="品牌权重" width="150"/>
        <el-table-column prop="descr" label="品牌描述" width="150"/>
  ...
  export default {
    ...
    methods: {
      loadData: function () {
        ...
        Utils.ajax(Api.dictionary.brand.list, params, (success) => {
