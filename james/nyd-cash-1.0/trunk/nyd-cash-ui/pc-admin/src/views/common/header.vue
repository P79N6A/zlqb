<template>
	<div class="layout-header">
		<div class="header-logo" style="font-family: Consolas;padding: 15px 0px 0px 10px">
      众合信息技术服务
    </div>
        ...
        <div class="loyout-right">
        	<span class="span-icon-loginout"></span>
        	<span class="span-icon-message"></span>
            <span class="span-text">lait</span>
        </div>
	</div>
</template>
<script>
...
<style lang="less">
	.layout-header{
	    ...
	    .header-logo{
	    	...
	    	width: 160px;
	      	height: 50px;
	      	/*background: #2267b5 url(../../assets/logo.png) no-repeat center center;*/
	    }
	    .head-navbar{
