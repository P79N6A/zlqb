...
public final class R {
	...
	public interface PGWConstant {
		...
		/** 异常 *///JsonChen@20150907 按照《证通技术标准_6_ESB技术规范V0.7》，更正上送异常类型为 W
		...
		/** 0.00 */
		public static final String ZERO_2_ACCURACY = "0.00";
		/** 真 */
		...
		/** 性别类型之未说明 */
		public static final String SEX_UNEXPLAN = "9";
		/** 绑定 */
		public static final String BIND = "0";
		/** 解绑 */
		public static final String UNBIND = "1";
		/** 单独账户验证*/
		public static final String VALAUTE_ACCOUNT = "3";
		/** 更新最后使用时间 */
		public static final String UPDATE_LAST_USED_TIME = "2";
		/** 快捷支付 绑定*/
		public static final String QUICK_BIND = "4";
		/** 支付密码控件加密随机key */
		public static final String RANDOM_KEY = "randomKey";
		/** 报文类型*/
		public static final String STRUCT_TYPE_XML = "XML";
		/** 默认商户号 */
		public static final String MERCHANTID = "000000000";
		/**收单机构号*/
		public static final String ACCEPT_ORGAN_NO = "0000110013";
		/** 业务种类之其他*/
		public static final String BIZ_KIND_OTHER = "09001";
		/**业务种类之账户余额查询*/
		public static final String BIZ_KIND_QUERY_ACCT_BALANCE = "03703";
		/**业务种类之账户余额查询*/
		public static final String BIZ_KIND_QUERY_TRAN_STATUS = "03701";
		
		public static final String RESULT = "result";
		/** 证件类型之身份证 */
		public static final String IDENTITY_TYPE_ID = "10";
		/** 证件类型之护照 */
		public static final String IDENTITY_TYPE_PASSPORT = "11";
		/** 证件类型之军官证 */
		public static final String IDENTITY_TYPE_OFFICER = "12";
		/** 机构类型之银行 */
		public static final String ORGAN_TYPE_BANK = "0";
		/** 机构类型之券商 */
		public static final String ORGAN_TYPE_TRADE = "1";
		/** 机构类型之商户 */
		public static final String ORGAN_TYPE_MERCHANT = "2";
		
		/**
		 * 累计限额 零值，表示不限额
		 */
		public static final Double AOUNT_LMT_ZERO = 0.00;
		public static final Integer INTEGER_ONE = new Integer(1);
		public static final String BLANK = "";

        /** 账户类型 支持 */
        public static final String SURRPORT = "1";
        /** 账户类型 不支持 */
        public static final String UNSURRPORT = "0";
        
        /** 机构支持 有效 */
        public static final String SURRPORT_ORGAN = "1";
        /** 机构支持 无效 */
        public static final String UNSURRPORT_ORGAN = "0";
        
        /** 是否超额    0未超额*/
		public static final String ISEXCESS_NO = "0";
		/** 是否超额    1超额*/
		public static final String ISEXCESS_YES = "1";
        
        /** 发送 短信验证码 / 需要支付密码*/
		public static final String NEED_SEND = "0";
		/** 不发送 短信验证码/ 不需要支付密码*/
		public static final String NEED_LESS = "1";
		
		/** BLACK_TYPE_ID : 黑名单查询类型  身份证	 */
		public static final String BLACK_TYPE_ID = "01";
		/** BLACK_TYPE_ACCOUNT : 黑名单查询类型- 账户	 */
		public static final String BLACK_TYPE_ACCOUNT = "02";
		
		/** ISCERTFLAG 是否全要素绑卡 0：全要素 	 */
		public static final String CERTFLAG = "0";
		/** NOCERTFLAG 是否全要素绑卡 1:非全要素 */
		public static final String NOCERTFLAG = "1";
		
		/**默认节点号*/
		public static final String DEFAULT_SYS_NODE = "99";
		
		/**单笔订单查询操作类型   删除*/
		public static final String IS_DELETE = "02";
		/**单笔订单查询操作类型   查询*/
		public static final String IS_QUERY = "01";
		/**是否删除单笔支付订单：不删除*/
		public static final String IS_NOTDELETE_PAYORDERINFO = "0";
		/**是否删除单笔支付订单：删除*/
		public static final String IS_DELETE_PAYORDERINFO = "1";
		
		/**支持交易日期类型-非节假日*/
		public static final String NOTHOLIDAYS = "1";
		/**支持交易时间类型-时间段*/
		public static final String TIME_QUANTUM = "1";
		
		/**是否是节假日-是*/
		public static final String IS_HOLIDAYS = "1";
		/**是否是节假日-否*/
		public static final String IS_NOTHOLIDAYS = "0";
		
		/**积分类型     1001普通积分*/
		public static final String COMMON_BONUS = "1001";
		/**积分类型     1002专用积分*/
		public static final String DEDICATED_BONUS = "1002";
		/**积分消费应答   00失败*/
		public static final String RETBONUS_CONSUMEFAIL = "00";
		/**积分消费应答   01成功*/
		public static final String RETBONUS_CONSUMESUCCESS = "01";
		
		/**退款方式   0自动*/
		public static final String REFOUND_STYLE_AUTO= "0";
		/**退款方式   1退款*/
		public static final String REFOUND_STYLE_REFOUND= "1";
		/**退款方式   2撤销*/
		public static final String REFOUND_STYLE_REVOKE= "2";

		/**页面错误码*/
		public static final String PAGE_ERROR_CODE="page_error_code";
		
		/**网联错误码规范 */
		public static final String NET_UNION_PAY_CODE = "P";
	...
	public interface PGWBonusBpBusiType {
		/** 业务类型    之 积分抵扣手续费 */
		public static final String BPBUISSTYPE_DUCFEE = "2001";
	}
	...
	public interface EAccountBalanceType {
		/** 可用余额 */
		public static final String AVAILABLE_BALANCE = "1";
		/** 待结算金额 */
		public static final String UNSETTLED_BALANCE = "2";
	}
	...
	public interface CASCurrency {
		/** 币种类型之人民币 */
		public static final String CURRENCY_CNY = "01";
	}
	...
	public interface PGWBusiField {
		...
		public static final String PAYER_ACCT_TYPE = "payerAcctType";
		public static final String PAYER_ACCT_NO = "payerAcctNo";
		public static final String PAYEE_ACCT_TYPE = "payeeAcctType";
		public static final String PAYEE_ACCT_NO = "payeeAcctNo";
		public static final String PROD_ORDER_TYPE = "prodOrderType";
		public static final String PROD_ORDER_STATUS = "prodOrderStatus";
		public static final String PAY_ORDER_TYPE = "payOrderType";
		public static final String PAY_ORDER_STATUS = "payOrderStatus";
		...
		public static final String PARAM_REQ_TRANFER_KEY="tranferKey";
		public static final String ORDER_TYPE = "orderType";
		public static final String STATUS = "status";
		public static final String ACCTNO = "acctNo";
		public static final String CTPYNM = "ctpynm";
		public static final String LOWPAYLMT = "lowPayLmt";
		public static final String HIGHPAYLMT = "highPayLmt";
		public static final String START_TIME = "startTime";
		public static final String END_TIME = "endTime";
		public static final String SUM_AMT = "sumAmt";
		public static final String USER_ID = "userId";
		public static final String CHECK_TYPE = "checkTyp";
		public static final String NEW_PAY_PWD = "newPayPwd";
		public static final String OPT_TYPE = "optTyp";
		public static final String ORIG_PAY_PWD = "origPayPwd";
		public static final String RANDOM_KEY = "randomKey";
		public static final String USER_ACCT_NO = "userAcctNo";
		public static final String CERT_TYPE = "certType";
		public static final String CERT_SEQ = "certSeq";
		 ...
		 * @since JDK 1.7
		 */
		public static final String SINGLE_AMOUNT_LIMIT = "singleAmountLimit";
		/**
		 * DAY_AMOUNT_LIMIT : 每日累计限额
		 * @since JDK 1.7
		 */
		public static final String DAY_AMOUNT_LIMIT = "dayAmountLimit";
		/**
		 * MONTH_AMOUNT_LIMIT : 每月限额
		 * @since JDK 1.7
		 */
		public static final String MONTH_AMOUNT_LIMIT = "monthAmountLimit";
		/**
		 * 机构类型
		 */
		 ...
		 * 商户通知URL （用于通知商户支付结果)
		 */
		public static final String MER_NOTIFY_URL = "merNotifyUrl";
		/**
		 * 转账（外转内）最小金额
		 */
		public static final String O_TO_I_TRANSFER_AMT_LEAST = "O_TO_I_TRANSFER_AMT_LEAST";
		/**
		 * 转账（外转内）非同名限制人数
		 */
		public static final String O_TO_I_TRANSFER_NM_LIMIT = "O_TO_I_TRANSFER_NM_LIMIT";
		/**
		 * 短信验证码超时时间
		 */
		public static final String SM_VERIFY_TIMEOUT="SM_VERIFY_TIMEOUT";
		/**
		 * 短信验证码间隔时间
		 */
		public static final String SM_VERIFY_PERIOD="SM_VERIFY_PERIOD";
		/**
		 * 短信验证码可连续验证错误次数
		 */
		public static final String SM_ERR_TIMES="SM_ERR_TIMES";
		/**
		 * 支付订单失效时间
		 */
		public static final String PAY_ORDER_VALID_TIME="PAY_ORDER_VALID_TIME";
		/**
		 * 延时转账收款失效时间
		 */
		public static final String DELAY_TRANSFER_VALID_TIME="DELAY_TRANSFER_VALID_TIME";
		/** 
		 * 备注
		 */
         ...
         *支持账户类型标识 0 不支持，1 支持
         */
        public static final String SURPPORT = "surpport";
        /**
         * 支付密码标识
         */
        public static final String PAY_PWD_FLG = "payPwdFlg";
        /**
         * 商户附件路径
         */
        public static final String BSP_MERC_ATTACH_FILE_PATH = "bsp_merc_attach_file_path";
        /**
         * 机构logo文件路径
         */
        public static final String PUB_ORGAN_LOGO_FILE_PATH = "pub_organ_logo_file_path";
        /**
         * 账户绑定卡的余额
         */
		 ...
		 * 短信验证码发送频率控制(一小时)
		 */
		public static final String SM_UPER_TIMES ="SM_UPER_TIMES ";
		/**
		 * 转账最大限额参数  500万
		 */
		public static final String TRANSFER_AMONNT_LIMIT="TRANSFER_AMONNT_LIMIT";
		/**
		 * 延迟转账每月最大参数控制
		 */
		public static final String MONTH_DELAY_MAX_TRAN_TIMES="MONTH_DELAY_MAX_TRAN_TIMES";
		/**
		 * 普通转账每月最大参数控制
		 */
		public static final String MONTH_MAX_TRAN_TIMES="MONTH_MAX_TRAN_TIMES";
		/**
		 * 延迟转账每日最大参数控制
		 */
		public static final String DAY_DELAY_MAX_TRAN_TIMES="DAY_DELAY_MAX_TRAN_TIMES";
		/**
		 * 普通转账每日最大参数控制
		 */
		public static final String DAY_MAX_TRAN_TIMES="DAY_MAX_TRAN_TIMES";
		/**
		 * 小额支付分钟参数
		 */
		public static final String MICRO_PAYMENT_MINUTE="MICRO_PAYMENT_MINUTE";
		/**
		 * 小额支付金额
		 */
		public static final String MICRO_PAYMENT_AMOUNT="MICRO_PAYMENT_AMOUNT";
		/**
		 * 小额支付笔数 
		 */
		public static final String MICRO_PAYMENT_COUNT="MICRO_PAYMENT_COUNT";
		/**
		 * 备付金预警最低金额
		 */
		public static final String MISMATCH_PROVISIONS_AMOUNT="MISMATCH_PROVISIONS_AMOUNT";
		/**
		 * 是否启用积分
		 */
		public static final String IS_DERAILBONUS="IS_DERAILBONUS";
		/**
		 * 是否启用红包
		 */
		public static final String IS_DERAILREDPACKET="IS_DERAILREDPACKET";
		/**
		 * 是否启用邮箱通知
		 */
		public static final String IS_DERAILMAIL="IS_DERAILMAIL";
		/**
		 * 是否启用商户对账文件发送
		 */
		public static final String IS_MERFILE_DELIVER="IS_MERFILE_DELIVER";
	...
	public interface PGWChannelId {
		/** 渠道类型之pc门户 */
		public static final String CHANNEL_PC_PORTAL = "01";
		/** 渠道类型之移动门户 */
		public static final String CHANNEL_MOBILE_PORTAL = "02";
		/** 渠道类型之webchat门户 */
		public static final String CHANNEL_WEBCHAT = "03";
		/** 渠道类型之支付网关 */
		public static final String CHANNEL_PGW = "04";
		/** 渠道类型之短信平台 */
		public static final String CHANNEL_SMSP = "05";
		/** 渠道类型之商户平台 */
		public static final String CHANNEL_MSS = "06";
		/** 渠道类型之产品销售服务平台 */
		public static final String CHANNEL_PRODUCT = "07";
		/** 渠道类型之开放平台 */
		public static final String CHANNEL_OPEN = "08";
		/** 渠道类型之PSB总线 */
		public static final String CHANNEL_PSB = "09";
		/** 渠道类型之账户前置 */
		public static final String CHANNEL_CORE = "10";
		/** 渠道类型之运营管理系统 */
		public static final String CHANNEL_OPER = "11";
		/** 渠道类型之差错处理平台 */
		public static final String CHANNEL_MISTAKE = "12";
		/** 渠道类型之计费平台 */
		public static final String CHANNEL_FEE = "13";
		/** 渠道类型之客户关系管理系统 */
		public static final String CHANNEL_CIF = "14";
	}
	...
	public interface PGWChannelType {
		/** 柜面 */
		public static final String CHANNEL_TYPE_01="01"; //柜面
		/** WEB渠道 */
		public static final String CHANNEL_TYPE_02="02"; //WEB渠道
		/** APP渠道*/
		public static final String CHANNEL_TYPE_03="03"; //APP渠道
		/** 微信渠道 */
		public static final String CHANNEL_TYPE_04="04"; //微信渠道
		/** 电话渠道 */
		public static final String CHANNEL_TYPE_05="05"; //电话渠道
		/** 短信渠道 */
		public static final String CHANNEL_TYPE_06="06"; //短信渠道
		/** 自助渠道（ATM、CDM） */
		public static final String CHANNEL_TYPE_07="07"; //自助渠道（ATM、CDM）
		/** POS */
		public static final String CHANNEL_TYPE_08="08"; //POS
		/** 电话POS */
		public static final String CHANNEL_TYPE_09="09"; //电话POS
		/** MPOS（手机刷卡器 */
		public static final String CHANNEL_TYPE_10="10"; //MPOS（手机刷卡器）
		/** 其他*/
		public static final String CHANNEL_TYPE_99="99"; //其他
	}
	...
	public enum ECTSystemEnum{
		...
		private ECTSystemEnum(String value, String label) {
			this.value = value;
			this.label = label;
		}
	...
	public enum PGWUserAcctTypeEnum {
		...
		private PGWUserAcctTypeEnum(String value, String label) {
			this.value = value;
			this.label = label;
		}
	...
	public enum PGWBindAcctTypeEnum {
		...
		private PGWBindAcctTypeEnum(String value, String label) {
			this.value = value;
			this.label = label;
		}
	...
	public enum PGWErrorEnum {
		...
		private PGWErrorEnum(String value, String label) {
			this.value = value;
			this.label = label;
		}
	...
	public enum PGWOrderStatus {
		...
		private PGWOrderStatus(String value, String label) {
			this.value = value;
			this.label = label;
		}
	...
	public enum PGWTransferStatus {
		...
		private PGWTransferStatus(String value, String label) {
			this.value = value;
			this.label = label;
		}
	...
	public interface PGWTransferPayeeRecStatus{
		/**收款人登记簿的状态01 有效 */
		public static final String TRANSFER_PAYEE_REC_STATUS_01 = "01";
		/**收款人登记簿的状态02 无效 */
		public static final String TRANSFER_PAYEE_REC_STATUS_02 = "02";
	}
	...
	public interface PGWTransferPayeeRecSelfFlag{
		/**收款人登记簿是本人 */
		public static final String TRANSFER_PAYEE_REC_SELF_FLAG_1 = "1";
		/**收款人登记簿是他人 */
		public static final String TRANSFER_PAYEE_REC_SELF_FLAG_2 = "2";
	}
	...
	public interface SmsConstant {
		...
		public static final String HEADVERSION = "1";

		/** 请求方请求的服务版本号。版本号结构为：X.Y */
		public static final String VERSION = "1.01";

		/** 服务请求方的ID。参照《证通技术标准_2_系统编号》中的系统ID英文简称。 */
		public static final String REQUESTID = "PGW";

		/** 交易处理系统需指定目标系统ID */
		public static final String TARGETID = "SMS";

		/** 渠道ID,参照《证通技术标准_3_渠道编号》 */
		public static final String CHANNELID = "04";

		/** 系统编码，参照《证通技术标准_2_系统编号》中的系统编码 */
		public static final String SYSCODE_PGW = "1011";

		/** 默认 发送级别 */
		public static final String SEND_LEVEL = "6";
		...
		public static final String BIZ_TYPE = "10110008";

		/**
		 * 短信功能类型 00.登录验证码 01.支付动态密码 02.注册验证码 03.找回密码
		 */
		public static final String SMS_FUNC_TYPE_00 = "00";
		public static final String SMS_FUNC_TYPE_01 = "01";
		public static final String SMS_FUNC_TYPE_02 = "02";
		public static final String SMS_FUNC_TYPE_03 = "03";

		/**
		 * 登录标记 0未登录 1已登录
		 */
		public static final String SMS_LOGIN_FLAG_0 = "0";
		public static final String SMS_LOGIN_FLAG_1 = "1";
	...
	public interface CifConstant {
		...
		public static final String VERSION = "1.01";
		/** 服务请求方的ID。参照《证通技术标准_2_系统编号》中的系统ID英文简称。 */
		public static final String REQUEST_ID = "PGW";
		/** 交易处理系统需指定目标系统ID */
		public static final String TARGET_ID = "CIF";
		/** 交易处理系统需指定目标系统ID EPS */
		public static final String TARGET_EPS_ID = "EPS";
		/** 交易处理系统需指定目标系统ID EPS */
		public static final String TARGET_RES_ID = "RES";
		/** 交易处理系统需指定目标系统ID OMS */
		public static final String TARGET_OMS_ID = "OMS";
		/** 渠道ID，参照《证通技术标准_3_渠道编号》 */
		public static final String CHANNEL_ID = "04";
		/** 密码类型：PC */
		public static final String PWD_TYPE_PC = "0";
		/** 密码类型：mobile */
		public static final String PWD_TYPE_MOBILE = "1";
		/** 默认 发送级别 */
		public static final String SEND_LEVEL = "6";
		/** 发送成功的标示 */
		public static final String SEND_SUCC = "Y";
		/** 支付密码调用失败 */
		public static final String ERROR_USERAUTH_PAYPASS_FAIL = "10339020";
		/** 支付密码锁定 */
		public static final String ERROR_USERINFO_PAYPASS_LOCKED = "10339012";
		/** 支付密码待锁定 */
		public static final String ERROR_USERINFO_PAYPASS_RLOCKED = "10339013";
	...
	public interface TACSBusiStatus {
		/**已请算*/
		public static final String SETTLE = "PR00";		
		/**已拒绝*/
		public static final String DECLINE = "PR01";
		/**已成功*/
		public static final String SUCCESS = "PR02";
		/**已接收*/
		public static final String ACCEPT = "PR03";
		/**已确认*/
		public static final String SUBMIT = "PR04";
		/**已付款*/
		public static final String PAYMENT = "PR05";
	}
	...
	public interface TACSQueryStatus{
		/**查询失败*/
		public static final String QUERY_FAIL = "PR01";		
		/**查询成功*/
		public static final String QUERY_SUCCESS = "PR02";
	}
	...
	public interface CASBusiStatus {
		public static final String SUCCESS = "50010000"; 
	}
	...
	public interface TACSBusiType {		
		/** 实时转账*/
		public static final String REALTIME_TRANFER = "A100";
		/** 延时转账转出或退款*/
		public static final String DELAY_TRANFER_OUT = "A200";
		/** 延时转账转入*/
		public static final String DELAY_TRANFER_IN = "A201";
		/** 消费*/
		public static final String ONLINE_CONSUME = "B100";
		/** 消费撤销*/
		public static final String CONSUME_CANCEL = "B101";
		/** 消费退货*/
		public static final String CONSUME_RETURN = "B200";
		/** 延迟转账退款*/
		public static final String DELAY_TRANFER_REFUND = "A202";
		/**账户余额查询*/
		public static final String QUERY_ACCT_BALANCE = "J200";
		/**账户明细查询*/
		public static final String QUERY_ACCT_DETAIL = "J300";
		/**业务状态查询(与交易明细查询相同)*/
		public static final String QUERY_TRANS_STATUS = "I100";
		/**交易明细查询*/
		public static final String QUERY_TRANS_DETAIL = "I100";
		/**理财产品购买(预约)*/
		public static final String FINANCING_PURCHASE = "F100";
		/**理财产品购买(即时)*/
		public static final String FINANCING_PURCHASE_REALTIME = "F101";
		/**理财产品购买(预约)撤销*/
		public static final String RESCIND_RESERVATION = "F102";
		/**完成购买*/
		public static final String PURCHASE_COMPLETION = "F200";
		/**完成购买撤销*/
		public static final String RESCIND_PURCHASE_COMPLETION = "F201";
		/**单笔代付*/
		public static final String SINGLE_PAYMENT = "E101";
		/**单笔代收*/
		public static final String SINGLE_COLLECTION = "E100";
		/**销售赎回*/
		public static final String SALES_REDEMPTION = "F300";
		/**账户验证*/
		public static final String CHECK_ACCT="J100";
	}
    ...
    public interface TerminalType{
         ...
         * 订单发起终端类型-手机
         */
        public static final String TER_TYPE_MOBILE = "01";
        /**
         * 订单发起终端类型-PAD
         */
        public static final String TER_TYPE_PAD = "02";
        /**
         * 订单发起终端类型-PC
         */
        public static final String TER_TYPE_PC = "03";
    }

	public interface ECTSystemOrgNum {	
		/** 支付转接机构号*/
		public static final String PAY_TRUN_ACCEPT = "0000100000";//1000000000
		/** 支付网关机构号*/
		public static final String PAY_NET_CHECKPOINT = "0000110013";//206000001
		/** 支付转接机构号CAS*/
		public static final String PAY_TRUN_ACCEPT_CAS = "0000100000";//1000000000
	}
	...
	public interface TACSBusiRejectCode {
		/** 交易超时 */
		public static final String TIMEOUT = "RJ60";
		/**原交易不存在*/
		public static final String QRY_TRANS_NOT_EXIST = "50011041";
	}
	...
	public interface TACSHandleStatus {
		/** 报文接收成功 */
		public static final String RECEIVE_SUCCESS = "0000";
	}
	...
	public interface PGWPayOrderMethod {
		/**担保支付*/
		public static final String WARRANTY_PAYMENT = "01";
		/**立即支付*/
		public static final String IMMEDIATE_PAYMENT = "02";
	}
	...
	public interface PGWOrderType {
		/**线上消费（快捷支付）*/
		public static final String ONLINE_CONSUME = "0100";
		/**普通转账*/
		public static final String NORMAL_TRANSFER = "0200";
		/**延时转账转出*/
		public static final String DELAY_TRANSFER_OUT = "0300";
		/**购买理财产品*/
		public static final String BUY_FINANCING_PRODUCT = "0400";
		/**发红包*/
		public static final String REDPACK_SEND = "0500";
		/**红包提现*/
		public static final String REDPACK_WITHDRAW = "0600";
		/**收零钱红包*/
		public static final String REDPACK_RECEIVE = "0700";
		/**零钱红包退款*/
		public static final String REDPACK_RETURN = "0800";
		/**消费退货*/
		public static final String CONSUME_RETRUN = "0900";
		/**延时转账转入*/
		public static final String DELAY_TRANSFER_IN = "1000";
		/**延时转账退款*/
		public static final String DELAY_TRANSFER_REFUND = "1100";
		/**消费撤销*/
		public static final String CONSUME_CANCEL = "1200";
		/**信用卡还款*/
		public static final String CREDIT_CARD_REPAY = "1300";
		/**加油卡充值*/
		public static final String FUEL_CARD_RECHARGE = "1400";
		/**手机充值*/
		public static final String PHONE_RECHARGE = "1500";
		/**单笔代付（快捷支付）*/
		public static final String SINGLE_PAY = "1600";
		/** 绑定证券账户(此处无字典只作为判断短信类型映射，如若冲突可以修改页面JS和此处的常亮值)*/
		public static final String BIND_ACCOUNT = "10001";
		/** 绑定证券账户(此处无字典只作为判断短信类型映射，如若冲突可以修改页面JS和此处的常亮值)*/
		public static final String BIND_CARD = "10002";
		/**小额支付*/
		public static final String MICRO_PAY = "1700";
		/**零钱充值*/
		public static final String POCKET_RECHARGE = "1800";
		/**零钱提现*/
		public static final String POCKET_WITHDRAW = "1900";
		/**小额支付退款*/
		public static final String MICRO_RETRUN = "2000";
		/**电子账户转账*/
		public static final String EACCOUNT_TRANSFER = "2100";
		/**订单结算*/
		public static final String ORDER_SETTLE = "2200";
		/**批量代收*/
		public static final String BATCH_COLLECT = "2300";
		/**批量代付*/
		public static final String BATCH_AGENTPAY = "2400";
		/**单笔代收*/
		public static final String SINGLE_COLLECT = "2500";
	}
	...
	public interface PGWOrderDetailType {
		/**普通转账-圈内转圈内*/
		public static final String NORMAL_TRANSFER_IN_2_IN = "0201";
		/**普通转账-圈内转圈外*/
		public static final String NORMAL_TRANSFER_IN_2_OUT = "0202";
		/**普通转账-圈外转圈内，非同名*/
		public static final String NORMAL_TRANSFER_OUT_2_IN_NEGTIVE = "0203";
		/**普通转账-圈外券圈外*/
		public static final String NORMAL_TRANSFER_OUT_2_OUT = "0204";		
		/**普通转账-圈外转圈内，同名*/
		public static final String NORMAL_TRANSFER_OUT_2_IN_SAME = "0205";
		/**普通转账-证通宝转入*/
		public static final String NORMAL_TRANSFER_ZTB_DEPOSIT = "0206";
		/**发红包-账户支付（红包支付）*/
		public static final String REDPACK_SEND_ACCT_PAY="0501";
		/**发红包-零钱支付（零钱发红包）*/
		public static final String REDPACK_SEND_POCKET_PAY="0502";
		/**转账交易-前两位*/
		public static final String NORMAL_TRANFER_PREFIX = "02";
		/**小额支付-投顾*/
		public static final String MICRO_PAY_CONSULTANT = "1701";
		/**小额支付-红包*/
		public static final String MICRO_PAY_REDPACK = "1702";
		/**零钱充值-细类*/
		public static final String POCKET_RECHARGE_DETAIL = "1801";
		/**零钱提现-细类*/
		public static final String POCKET_WITHDRAW_DETAIL = "1901";
	}
	/**
	...
	public interface TACSFuncNo {
		/** 转账请求 */
		public static final String ESB_TRANFER_CODE = "TACS.200.001.01";
		/** 延迟转出请求 */
		public static final String ESB_DELAY_TRANFER_OUT_CODE = "TACS.202.001.01";
		/** 延迟转入请求 */
		public static final String ESB_DELAY_TRANFER_IN_CODE = "TACS.204.001.01";
		/** 线上消费 */
		public static final String ESB_ONLINE_CONSUME_CODE = "TACS.240.001.01";
		/** 消费撤销 */
		public static final String ESB_RESCIND_CONSUMPTION = "TACS.242.001.01";
		/** 消费退货 */
		public static final String ESB_RETURN_CONSUMPTION = "TACS.244.001.01";
		/** 延迟转账退款 */
		public static final String ESB_DELAY_TRANFER_REFUND= "TACS.206.001.01";
		/** 交易状态查询 */
		public static final String ESB_QUERY_TRAN_STATUS= "TACS.300.001.01";
		/** 通讯级确认 */
		public static final String ESB_MSG_PROCESS= "TACS.990.001.01";
		/** 消费撤销 */
		public static final String ESB_CONSUME_CANCEL_CODE = "TACS.242.001.01";
		/** 消费退款 */
		public static final String ESB_CONSUME_RETURN_CODE = "TACS.244.001.01";
		/** 账户余额查询 */
		public static final String ESB_QUERY_ACCT_BALANCE_CODE = "TACS.332.001.01";
		/** 账户明细查询 */
		public static final String ESB_QUERY_ACCT_DETAIL_CODE = "TACS.334.001.01";
		/** 交易明细查询 */
		public static final String ESB_QUERY_TRANS_DETAIL_CODE = "TACS.306.001.01";
		/** 理财产品购买 */
		public static final String ESB_FINANCING_PURCHASE_CODE = "TACS.220.001.01";
		/** 理财产品购买撤销 */
		public static final String ESB_RESCIND_RESERVATION_CODE = "TACS.222.001.01";
		/** 完成购买 */
		public static final String ESB_PURCHASE_COMPLETION_CODE = "TACS.224.001.01";
		/** 完成购买撤销 */
		public static final String ESB_RESCIND_PURCHASE_COMPLETION_CODE = "TACS.226.001.01";
		/** 单笔代付 */
		public static final String ESB_SINGLE_PAYMENT_CODE = "TACS.272.001.01";
		/** 单笔代收 */
		public static final String ESB_SINGLE_COLLECTION_CODE = "TACS.270.001.01";
		/** 销售赎回 */
		public static final String ESB_SALES_REDEMPTION_CODE = "TACS.228.001.01";
		/** 账户验证 */
		public static final String ESB_CHECK_ACCT_CODE="TACS.330.001.01";
	}
	...
	public interface EPSFuncNo {
		/** 积分消费请求 */
		public static final String BONUSCONSUME_CODE = "EPS.102.007.01";
		/**积分消费冲正请求 */
		public static final String BONUSCONSUMEREVERSAL_CODE = "EPS.102.008.01";
		/** 积分余额查询请求*/
		public static final String BONUSQUERY_CODE = "EPS.101.001.01";
	}
    ...
    public interface FundType{
    	 ...
    	 * 自有资金
    	 */
    	public static final String SELF_OWNED_FUND = "00";
        /**
         * 客户资金（证券保证金）
         */
        public static final String SECURITIES_MARGIN_FUND = "01";
        /**
         * 客户资金（信用）
         */
        public static final String CREDIT_FUND = "02";
        /**
         * 客户资金（衍生品）
         */
        public static final String DERIVATIVE_FUND = "03";
        /**
         * 客户资金（期货保证金）
         */
        public static final String COVER_FUND = "30";
    }
	...
	public interface CASFuncNo {
		/**一借一贷*/
		public static final String ESB_ODOC_CODE = "CAS.260.001.01";
		/**多借多贷*/
		public static final String ESB_MDMC_CODE = "CAS.262.001.01";
		/**记账冲正*/
		public static final String ESB_REVERSE_CODE = "CAS.264.001.01";
		/**记账查证*/
		public static final String ESB_QUERY_CODE = "CAS.266.001.01";
	}
	...
	public interface UserEntitlement{
		/** 菜单类型-运营中心管理员 */
		public static final String DEFAULT_MENU_TYPE = "1";
		/** 菜单类型-商户管理 */
		public static final String MERCHANT_MENU_TYPE = "2";
	}
	...
	public interface ScheduleJobKey {
		/** 测试job1 */
		public static final String SCHEDULE_JOB_KEY_TEST1 = "201505300001";
		/** 测试job1 */
		public static final String SCHEDULE_JOB_KEY_TEST2 = "201505300002";
		/** 分润清分job */
		public static final String SCHEDULE_JOB_KEY_PARTPROFIT_CLEAR="PART_PROFIT_CLEAR";
		/** 分润结算job */
		public static final String SCHEDULE_JOB_KEY_PARTPROFIT_SETT="PART_PROFIT_SETT";
	}
	...
	public interface ScheduleJobStatus {
		/** 待执行 */
		public static final String SCHEDULE_JOB_STATUS_WAIT_INVOKE = "0";
		/** 执行中 */
		public static final String SCHEDULE_JOB_STATUS_INVOKING = "1";
		/** 执行成功 */
		public static final String SCHEDULE_JOB_STATUS_INVOKE_SUCC = "2";
		/** 执行失败 */
		public static final String SCHEDULE_JOB_STATUS_INVOKE_FAIL = "3";
	}
	...
	public interface PGWOrderQueryType {
		/**有循环体*/
		public static final String WITH_LOOP = "0";
		/**无循环体*/
		public static final String WITHOUT_LOOP = "1";
	...
	public interface FaceFlag {
		/**需要刷脸*/
		public static final String DESIRED = "1";
		/**不需要刷脸*/
		public static final String UNDESIRED = "0";
		/**使用中*/
		...
		/**未通过视频认证*/
		public static final String UNPASSED = "0";
	}
	...
	public interface TACSOrderReqType{
		...
		public static final String MOBILE="mobile";
		/* 身份鉴权绑卡 */
		public static final String BIND_CARD = "payBindCardInfo";
	}
	...
	public interface PGW_AMT_LIMTT_TYPE{
		 ...
		 * AMT_LIMTI_DAY : 日累计限额
		 */
		public static final String AMT_LIMTI_DAY="02";
		/**
		 * AMT_LIMTI_MONTH : 月累计限额
		 */
		public static final String AMT_LIMTI_MONTH="03";
		/**
		 * AMT_LIMTI_ONE : 单笔累计限额
		 */
		public static final String AMT_LIMTI_SINGLE="01";
	}
	...
	public interface CIFChangePwdOptType {
		/**设置/重置密码*/
		public static final String RESET_PWD = "0";
		/**修改密码*/
	...
	public enum OptFlag {
		...
		private OptFlag(String value, String label) {
			this.value = value;
			this.label = label;
		}
	...
	public interface MallStaffStatus {
		public static final String MALL_STAFF_IS_IN_USE_TRUE = "1";
		public static final String MALL_STAFF_IS_IN_USE_FALSE = "0";
	}
	...
	public enum SyncUserType {
		...
		private SyncUserType(String value,String userType, String label) {
			this.value = value;
	...
	public enum DefaultUserRole {
		...
		private DefaultUserRole(String value, String label) {
			this.roleId = value;
			this.label = label;
		}
	...
	public enum UserStatus {
		...
		private UserStatus(String value, String label) {
			this.value = value;
			this.label = label;
		}
	...
	public interface PGWOrderFeeType {
		/**按笔固定金额*/
		public static final String ORDER_FEE_TYPE_01 = "01";
		/**按金额阶梯*/
		public static final String ORDER_FEE_TYPE_02 = "02";
		/**按支付金额比例*/
		public static final String ORDER_FEE_TYPE_03 = "03";
	}
	...
	public interface PGWOrganProfitType {
		/**按笔固定金额*/
		public static final String PROFIT_TYPE_FIX = "01";
		/**按本金比例*/
		public static final String PROFIT_TYPE_PRINCIPAL_PERCENT = "02";
		/**
		 * 按收单侧比例
		 * 收单侧金额=商务平台手续费-发卡转接成本
		 */
		public static final String PROFIT_TYPE_CHARGE_PERCENT = "03";
	}
	
	public interface PGWUserRegisterWay {
		/**手机号注册*/
		public static final String REGISTER_BY_MOBILE = "0";
		/**邮箱注册*/
		public static final String REGISTER_BY_EMAIL = "1";
	}
	...
	public enum PGWMerchantStatus {
		...
		private PGWMerchantStatus(String value, String label) {
			this.value = value;
			this.label = label;
		}
	...
	public enum WebServiceFunctionId {
		...
		private WebServiceFunctionId(String value, String label) {
			this.value = value;
			this.label = label;
		}
	...
	public enum MercAccountTransType {
		...
		private MercAccountTransType(String value, String label) {
			this.value = value;
			this.label = label;
		}
	...
	public enum MercAccountTransStatus {
		...
		private MercAccountTransStatus(String value, String label) {
			this.value = value;
			this.label = label;
		}
	...
	public enum MercAccountDetailDcflag {
		...
		private MercAccountDetailDcflag(String value, String label) {
			this.value = value;
			this.label = label;
		}
	...
	public enum MercAccountDetailReverseflag {
		...
		private MercAccountDetailReverseflag(String value, String label) {
			this.value = value;
			this.label = label;
		}
	...
	public enum MercAccountDetailTransType {
		...
		private MercAccountDetailTransType(String value, String label) {
			this.value = value;
			this.label = label;
		}
	...
	public enum PGWMercOrPersonTransType {
		...
		private PGWMercOrPersonTransType(String value, String label) {
			this.value = value;
			this.label = label;
		}
	...
	public enum PGWMerchantFeeMethod {
		...
		private PGWMerchantFeeMethod(String value, String label) {
			this.value = value;
			this.label = label;
		}
	...
	public interface AuditBusiType {
		public static final String AUDIT_MERCHANT_APPLY = "00";
		public static final String AUDIT_MERCHANT_INFO_CHANGE = "01";
		public static final String AUDIT_MERCHANT_ACCT_LOGOUT = "02";
		public static final String AUDIT_MERCHANT_CHARGE_NOTIFY = "03";
		public static final String AUDIT_SUPPORT_ORGAN_ADD = "07";
		public static final String AUDIT_SUPPORT_ORGAN_UPDATE = "08";
	}
	...
	public interface AuditResult {
		/** 初审拒绝 */
		public static final String RESULT_AUDIT_REJECT = "0";
		/** 复审拒绝 */
		public static final String RESULT_REAUDIT_REJECT = "1";
		/** 审核通过 */
		public static final String RESULT_AUDIT_APPROVE = "2";
	}
	...
	public interface AuditStatus {
		/** 待初审 */
		public static final String STAUTS_TODO_AUDIT = "0";
		/** 待复审 */
		public static final String STAUTS_TODO_REAUDIT = "1";
		/** 审核完成 */
		public static final String STAUTS_COMPLETED_AUDIT = "2";
	}
	...
	public interface AuditParamKey {
		/** 审核业务类型 */
		public static final String KEY_AUDIT_BUSI_TYPE = "KEY_AUDIT_BUSI_TYPE";
		/** 审核业务ID*/
		public static final String KEY_AUDIT_BUSI_ID = "KEY_AUDIT_BUSI_ID";
		/** 审核结果 */
		public static final String KEY_AUDIT_RESULT = "KEY_AUDIT_RESULT";
		/** 审核状态 */
	...
	public enum CASAbstract  {
		...
		private CASAbstract(String value, String label) {
			this.value = value;
			this.label = label;
		}
	...
	public enum BatchCollectPaystate  {
		...
		private BatchCollectPaystate(String value, String label) {
			this.value = value;
			this.label = label;
		}
	...
	public enum BatchNotifyState  {
		...
		private BatchNotifyState(String value, String label) {
			this.value = value;
			this.label = label;
		}
	...
	public interface PGWCutDayStatus {
		/** 日切完成 */
		public static final String CUT_DAY_STATUS_DONE = "01";
		/** 日切中 */
		public static final String CUT_DAY_STATUS_OPERATING  = "02";
	}
	...
	public interface PGWMercSettAcctType {
		/** 结算账户 */
		public static final String TYPE_SETTLEMENT = "01";
		/** 费用账户 */
		public static final String TYPE_CHARGE  = "02";
	}
	...
	public enum PGWMercFileType {
		...
		private PGWMercFileType(String value, String label) {
			this.value = value;
			this.label = label;
		}
	...
	public interface DcFlag {
		/** 借记 */
		public static final String DEBIT_FLAG = "1";
		/** 贷记 */
		public static final String CREDIT_FLAG  = "2";
	}
	...
	public enum TACSDistributionFileStatus {
		...
		private TACSDistributionFileStatus(String value, String label) {
			this.value = value;
			this.label = label;
		}
	...
	public enum PGWAccountingEntryStatus{
		...
		private PGWAccountingEntryStatus(String value, String label) {
			this.value = value;
			this.label = label;
		}
	...
	public enum PGWRemitMethod{
		...
		private PGWRemitMethod(String value, String label) {
			this.value = value;
			this.label = label;
		}
	...
	public interface PGWOranTranAuthType {
		/** 允许 */
		public static final String AUTH_ARGEE = "AS00";
		/** 禁止 */
		public static final String AUTH_REFUSE  = "AS01";
	}
	...
	public enum CcsFileType{
		...
		private CcsFileType(String value, String label) {
			this.value = value;
			this.label = label;
		}
	...
	public enum PGWCheckResult{
		...
		private PGWCheckResult(String value, String label) {
			this.value = value;
			this.label = label;
		}
	...
	public enum SysFlag{
		...
		private SysFlag(String value, String label) {
			this.value = value;
			this.label = label;
		}
	...
	public enum MercCertIdType{
		...
		private MercCertIdType(String new_value, String old_value,String label){
	...
	public enum MerchantCertStatus{
		...
		private MerchantCertStatus(String value, String label) {
			this.value = value;
			this.label = label;
		}
	...
	public interface PGWDevicePKIFalg {
		/** 没有安装证书 */
		public static final String DEVICE_PKI_FALG_0 = "0";
		/** 安装证书 */
		public static final String DEVICE_PKI_FALG_1  = "1";
	}
	...
	public enum PGWMismatchType{
		...
		private PGWMismatchType(String value, String label) {
			this.value = value;
			this.label = label;
		}
	...
	public interface TACSBizKind {
		/**交易状态查询*/
		public static final String BIZ_KIND_QUERY_TRANS_STATUS = "03701";
		/**交易明细查询*/
		public static final String BIZ_KIND_QUERY_TRANS_DETAIL = "03702";
		/**零钱支付 */
		public static final String BIZ_KIND_BALANCE_PAY = "07401";

		/**零钱充值*/
		public static final String BIZ_KIND_BALANCE_RECHARGE="07101";
		/**零钱提现*/
		public static final String BIZ_KIND_BALANCE_WITHDRAW="07201";
	}
	
	public interface IsRichFriend{
		/**非财友转账*/
		public static final String IS_RICH_FRIEND_0="0";
		/**财友转账*/
		public static final String IS_RICH_FRIEND_1="1";
	}
	...
	public interface EPSBonusConsumeResCode{
		/**失败*/
		public static final String RES_CODE_FAIL = "00";
		/**成功*/
		public static final String RES_CODE_SUCCESS = "01";
	}
	...
	public enum BonusConsumeTranStatus{
		...
		private BonusConsumeTranStatus(String value, String label) {
			this.value = value;
			this.label = label;
		}
	...
	public interface PGW_PAY_Constant {
		...
		public static final String QUERY_PAY_ORDER_TYPR_0 = "0";
		public static final String QUERY_PAY_ORDER_TYPR_1 = "1";
		public static final String QUERY_PAY_ORDER_TYPR_2 = "2";
		public static final String QUERY_PAY_ORDER_TYPR_3 = "3";
		
		/** 是否有退货 */
		public static final String IS_RETURNED = "1"; 	  // 1代表撤销
		public static final String UN_RETURNED = "0"; 	  // 0代表未撤销
		
		/** 是否有退货 */
		public static final String IS_REVERT = "1"; 	  // 1代表退货
		public static final String UN_REVERT = "0"; 	  // 0代表未退货
		
		/** 撤销退款标记 */
		public static final String REVERT_FLAG	 = "00";	//撤销
		public static final String RETURNED_FLAG = "01";	//退款
		
		/** 快捷支付用户id填充 */ 
		public static final String QUERY_PAY_DEFAULT_USERID = "-1";	//CIF 的规则是  [yyyyMMdd]{########}
	...
	public enum PGWPayResult{
		...
		private PGWPayResult(String value, String label) {
			this.value = value;
			this.label = label;
		}
		public String getValue() {
	...
	public enum MercAccountFrzType {
		...
		private MercAccountFrzType(String value, String label) {
			this.value = value;
			this.label = label;
		}
	...
	public enum MercAccountFrzStatus {
		...
		private MercAccountFrzStatus(String value, String label) {
			this.value = value;
			this.label = label;
		}
	...
	public enum RedPacketStatus {
		...
		private RedPacketStatus(String value, String label) {
			this.value = value;
			this.label = label;
		}
	...
	public interface RES_QUERY_RETURN_STATUS {
		public static final String RES_QUERY_RETURN_STATUS_NOTEXIST = "0";
		public static final String RES_QUERY_RETURN_STATUS_DEALING = "1";
		public static final String RES_QUERY_RETURN_STATUS_FAILURE = "2";
		public static final String RES_QUERY_RETURN_STATUS_SUCCESS = "3";
	}
	
	public interface ESB_RET_TYPE{
		//业务成功
		public static final String ESB_RET_TYPE_SUCESS = "Y";
		//业务失败
		public static final String ESB_RET_TYPE_FAIL   = "W";
		//技术失败
		public static final String ESB_RET_TYPE_ERROR  = "E";
	}
	...
	public interface ModelOpFlag {
		/** 不操作 */
		public static final String NO_OP_FLAG = "0";
		/** 插入操作 */
	...
	public interface RevertResult{
		/** 成功*/
		public static final String REVERT_SUCCESS = "0";
		/** 超时 */
		public static final String REVERT_TIMEOUT  = "1";
		/** 失败 */
		public static final String REVERT_FAILURE  = "2";		
	}
	...
	public interface EventType{
		...
		/*分享用户*/
		public static final String SHARE_USER="3"; 
	}
	...
	public enum PGWMercProperty{
		...
		private PGWMercProperty(String value, String label) {
			this.value = value;
			this.label = label;
		}
	...
	public interface PGWPayOrderMemoConstant {
		...
		/** 收款方机构类型*/
		public static final String PAYEE_ORGAN_NO = "payeeOrganNo";
		/** 收款方姓名*/
	...
	public enum PGWOmsTranSts{
		...
		private PGWOmsTranSts(String value, String label) {
			this.value = value;
			this.label = label;
		}
	...
	public enum PGWOnlineopenSettleRecStatus{
		...
		private PGWOnlineopenSettleRecStatus(String value, String label) {
			this.value = value;
			this.label = label;
		}
	...
	public enum PGWOnlineOpenAccountMercRole{
		...
		private PGWOnlineOpenAccountMercRole(String value, String label) {
			this.value = value;
			this.label = label;
		}
	...
	public enum PGWOnlineOpenAccountShareProfitStu{
		...
		private PGWOnlineOpenAccountShareProfitStu(String value, String label) {
			this.value = value;
			this.label = label;
		}
	...
	public enum PGWOnlineOpenKeepStatus{
		...
		private PGWOnlineOpenKeepStatus(String value, String label) {
			this.value = value;
			this.label = label;
		}
	...
	public interface PGWMercAccountType{
		/** 备付金虚拟账户*/
		public static final String MERC_ACCOUNT_TYPE_PROVISION_VIR = "01";
		/** 佣金虚拟账户*/
		public static final String MERC_ACCOUNT_TYPE_COMMISSION_VIR = "02";
	} 
	...
	public interface OMSTransferConstant{
		/** 行内转账 */
		public static final String OMS_PAYMENT_APPLY_TRANSFER_TYPE_00 = "00";
		/** 跨行转账*/
		public static final String OMS_PAYMENT_APPLY_TRANSFER_TYPE_01 = "01";
		/** 同城转账*/
		public static final String OMS_PAYMENT_APPLY_AREA_FLAG_00 = "00";
		/** 异地转账*/
		public static final String OMS_PAYMENT_APPLY_AREA_FLAG_01 = "01";
		/** 结算账号*/
		public static final String OMS_PAYMENT_APPLY_ACCT_TYPE_00 = "00";
		/** 记账码*/
		public static final String OMS_PAYMENT_APPLY_ACCT_TYPE_01 = "01";
		/** 清算账号*/
		public static final String OMS_PAYMENT_APPLY_ACCT_TYPE_02 = "02";
		/** 交易状态-21：成功 */
		public static final String OMS_PAYMENT_RESULT_QUERY_TRANSTS_21 = "21";
		/** 交易状态-20：可疑 */
		public static final String OMS_PAYMENT_RESULT_QUERY_TRANSTS_20 = "20";
		/** 交易状态-22：失败 */
		public static final String OMS_PAYMENT_RESULT_QUERY_TRANSTS_22 = "22";
	}
	...
	public enum PGWOmsCheckSts {
		...
		private PGWOmsCheckSts(String value, String label) {
			this.value = value;
			this.label = label;
		}
	...
	public interface PGWOnlineOpenSettlePeriod{
		/** 月 */
		public static final String SETTLE_PERIOD_M = "M";
		/** 季*/
		public static final String SETTLE_PERIOD_S = "S";
		/** 半年*/
		public static final String SETTLE_PERIOD_H = "H";
		/** 年*/
		public static final String SETTLE_PERIOD_Y = "Y";
	}
	...
	public interface PayApiConstant {
		...
		/** 交易处理系统需指定目标系统ID */
		public static final String TARGET_ID = "EAS";
	...
	public interface EAccountFile{
		...
		/** 最多往前偏移的天数 */
		public static final int SETTLE_DATE_OFFSET = 2;
		/** 迅联电子账户对账文件格式 */
		public static final String PREFIX_RECONCILIATION = "accountreconciliation";
		/** 迅联电子账户批量结算文件 */
		public static final String PREFIX_BATCH_SETTLE = "accountbatchsettle";
		/** 迅联电子账户文件前缀 */
		public static final String PREFIX_ZXF = "zxf";
		/** 证通内部文件前缀 */
		public static final String PREFIX_ECT = "ect";
	...
	public enum EAccountCheckFileStatus {
		...
		private EAccountCheckFileStatus(String value, String label) {
			this.value = value;
			this.label = label;
		}
	...
	public enum EAccountBatcheSettleFileStatus {
		...
		/** 构造函数 */
		private EAccountBatcheSettleFileStatus(String value, String label) {
			this.value = value;
			this.label = label;
		}
	...
	public interface EctbaoSysParam {
		public static final String CHANNELID = "000000000000";
		public static final String TRADEMODE = "APP";
	}
	...
	public interface PGWBatchNo{
		...
		public static final String BATCH_NO_1 = "1";		
		/** 18点对账批量(自然日T日18:00)
		 *  记录范围:清算日T日，自然日T日00:00至T日15:30 */
		public static final String BATCH_NO_2 = "2";
	}
	...
	public enum PGWMercSettleType {
		...
		private PGWMercSettleType(String value, String label) {
			this.value = value;
			this.label = label;
		}
	...
	public enum PGWCheckMismatchHandleStatus {
		...
		private PGWCheckMismatchHandleStatus(String value, String label) {
			this.value = value;
			this.label = label;
		}
	...
	public enum OmsPayeeAcctType {
		...
		private OmsPayeeAcctType(String value, String label) {
			this.value = value;
			this.label = label;
		}
	...
	public interface OmsTransferProvisionStatus{
		...
		/** 冻结成功*/
		public static final String FREEZE_SUCC = "01";
		/** 冻结失败 */
		public static final String FREEZE_FAIL = "02";
		/** 解冻成功 */
		public static final String UNFREEZE_SUCC = "03";
		/** 解冻失败 */
		public static final String UNFREEZE_FAIL = "04";
		/** 划账成功 */
		public static final String TRANSFER_SUCC = "05";
		/** 划账失败 */
		public static final String TRANSFER_FAIL = "06";
		/** 解冻失败已入差错 */
		public static final String UNFREEZE_IN_ERROR = "07";
		/** 划账失败已入差错 */
		public static final String TRANSFER_IN_ERROR = "08";
	}
	...
	public interface FundTradeFeeType{
		/** 人工核计 */
		public static final String ARTIFICIAL_NUCLEAR = "0";
		/** 按笔收取*/
		public static final String FEE_BY_RECORD = "1";
		/** 按比例收取 */
		public static final String FEE_BY_SCALE = "2";
	}
	...
	public interface TACSPayFlag{
		public static final String ACCOUNT_PAY_FLAG = "D001";
	}
	...
	public interface ZtbConstans{
		...
		/** 默认渠道号 */
		public static final String DEFAULT_CHANNEL_ID = "000000000000";
		/** 默认基金编号 */
		public static final String DEFAULT_FUND_CODE = "000709";
	}
	...
	public interface MERCHANTSIGNSOURCE {
		/** 后台验证 */
		public static final String SIGN_BY_INNER = "0";
		/** 商户调用鉴权接口*/
		public static final String SIGN_BY_INTERFACE = "1";
	}
	...
	public interface RiskTransType{
		...
		/**修改密码*/
		public static final String MODIFY_PASSWORD = "03";
		/**修改手机号*/
		public static final String MODIFY_MOBILE = "04";
		/**绑卡/实名认证*/
		public static final String REAL_NAME_AUTH = "05";
		/**提现*/
		public static final String WITHDRAW = "06";
		/**转账*/
		public static final String TRANSFER = "07";
		/**消费*/
		public static final String CONSUMPTION = "08";
		/**网银充值*/
		public static final String ONLINE_BANKING_RECHARGE = "09";
		/**快捷充值*/
		public static final String QUICK_RECHARGE = "10";
		/**鉴权*/
		public static final String SIGN = "11";
		/**代收*/
		public static final String COLLECTION = "12";
		/**代付*/
		public static final String AGENTPAY = "13";
		/**退货*/
		public static final String REFUND = "14";
		/**风控默认cstno*/
		public static final String DEFAULT_RISK_CSTNO = "0000000000";
		/**风控transCode默认前缀*/
		public static final String DEFAULT_RISK_PREFIX = "T1";
	}
	...
	public interface RiskChannelType{
		/** 商务平台*/
		public static final String PGW = "01";
		/**01-风控评估*/
		public static final String EVALUATION = "01";
		/**02-风控确认*/
	...
	public enum RiskPaccTypeEnum {
		...
		private RiskPaccTypeEnum(String value, String label) {
			this.value = value;
			this.label = label;
		}
	...
	public enum RiskFrontResultEnum {
		...
		private RiskFrontResultEnum(String value, String label) {
			this.value = value;
			this.label = label;
		}
	...
	public enum RiskFrontDisposalEnum {
		...
		private RiskFrontDisposalEnum(String value, String label) {
			this.value = value;
			this.label = label;
		}
	...
	public interface RiskProdType{
		/**1-证通支付*/
		public static final String ECT_PAY = "1";
		/**2-证通宝*/
		public static final String ECTBAO = "2";
		/**3-基金支付*/
		public static final String FUND_PAY = "3";
		/**4-二维码支付*/
		public static final String QR_CODE_PAY = "4";		
		/**5-公交卡*/
		public static final String TRANSIT_PAY = "5";
		/**6-云闪付*/
		public static final String CLOUD_FLASH_PAY = "6";
		/**7-信用卡还款*/
		public static final String CREDIT_CARD_REPAYMENT = "7";		
		/**8-境外支付*/
		public static final String OVERSEAS_PAY = "8";
		/**9-互金业务*/
		public static final String MUTUAL_FUND_BUSINESS = "9";
	}
	 ...
	 */
	 public interface RiskTerminalType{
         ...
         * 终端类型-0-未知或不区分
         */
        public static final String TER_TYPE_UNKNOWN = "0";
        /**
         * 终端类型-1-PC
         */
        public static final String TER_TYPE_PC = "1";
        /**
         * 终端类型-2-手机
         */
        public static final String TER_TYPE_MOBILE = "2";
        /**
         * 终端类型-3-ipad
         */
        public static final String TER_TYPE_IPAD = "3";
        /**
         * 终端类型-4-手表
         */
        public static final String TER_TYPE_WATCH = "4";
	 }
	...
	public enum RiskFrontResultStatusEnum {
		...
		private RiskFrontResultStatusEnum(String value, String label) {
			this.value = value;
			this.label = label;
		}
	...
	public interface BatchCollectAndPayBusyType{
		/**  0--批量代收   */
		public static final String BATCH_COLLET = "0";
		/**  1--批量代付   */
		public static final String BATCH_PAYMENT = "1";
	}
    ...
    public enum MERCHANTSETTLEPOINT {
        ...
        private MERCHANTSETTLEPOINT(String value, String label) {
            this.value = value;
            this.label = label;
        }
	...
	public interface SingleCollectTransStatus{
		...
		/**单笔代收状态  02-处理中*/
		public static final String DOING = "02";
		/**单笔代收状态  03-成功*/
	...
	public interface PGWCheckType {
		/**账户验证 */
		public static final String SIGN_AUTH = "1";
		/**短信发送 */
		public static final String SEND_SMS = "2";
		/**绑卡签约 */
		public static final String BIND_CARD = "3";
		/**代收委托 */
		public static final String ENDO_COLL = "4";
		/**第三方绑定*/
		public static final String THIRD_BIND = "5";
		/**解约 */
		public static final String SIGN_OUT = "6";
	...
	public interface PGWSignMethod {
		/**CIF签约 */
		public static final String CIF = "0";
		/**网联签约 */
		public static final String NET_UNION = "1";
	...
	public interface SystemCode {
		//支付网关1011
		public static final String PAYMENT_GATEWAY = "1011";
	    //商务平台1012
		public static final String MERCHANT_SERVICE = "1012";
		//生活服务中心1013
		public static final String LIFE_SERVICE = "1013";
	...
	public interface MerchantTrust{
		/**非信任商戶*/
		public static final String NON_TRUSTED_MERCHANT = "1";
		/**信任商戶*/
		public static final String TRUSTED_MERCHANT = "0";
	}
	...
	public interface CheckStatus{
		...
		public static final String FAIL = "2";
		/**验证处理中*/
		public static final String INPROCESS = "3";
	}
	...
	public interface SignValiuateStatus{
		/**首次/重新发起签约*/
		public static final String SIGN_AGAIN = "0";
		/**授信商户更新数据*/
		public static final String TRUST_UPDATE = "1";
		/**非授信商户拒绝重新签约返回错误*/
		public static final String UN_TRUST_REFUSE = "2";
		/**用户已签约*/		
		public static final String SIGN_EXITS = "3";	
	}
...
/** Function : PCAC系统参数<br/>     *
    ...
    public interface PCACSystemParams {
        ...
        public static final String MERCHANT_SERVICE = "1012";
        public static final String LIFE_SERVICE = "1013";
        public static final String IS_ABALE = "1";
        public static final String UN_ABALE = "0";
    }
	...
	public interface MercBatchPayLimit{
		/**限额开关 - 关闭*/
		public static final int QUOTA_SWITCH_CLOSE = 0;
		/**限额开关 - 打开*/
		public static final int QUPTA_SWICH_OPEN= 1;
		/**compareTo小于*/
    ...
    public enum NUCCBUSINESSTYPE {
        ...
        private NUCCBUSINESSTYPE(String value, String label) {
            this.value = value;
            this.label = label;
        }
	...
	public interface PCACTransCode{
		 ...
		 * 登陆
		 */
		public static final String LOGIN = "LR0001";
		/**
		 * 登出
		 */
		public static final String LOGINOUT = "LR0002";
		/**
		 * 商户风险信息变更查询
		 */
		public static final String  MERC_RISK_CHANGE_QUERY = "UP0003";
		/**
		 * 商户风险信息补录
		 */
		public static final String  MERC_RISK_CHANGE_AMENDED_RECORD = "UP0004";
		/**
		 * 特约商户信息差错处理
		 */
		public static final String MERC_ERROR_HANDING = "EDEL01";
		
		/**
		 * 风险信息补发申请
		 */
		public static final String INFO_REPUSH = "TS0004";
		/**
		 * 企业商户信息上报
		 */
		public static final String MERC_INFO_REPORT = "EER001";
		/**
		 * 商户风险信息上报
		 */
		public static final String RISK_INFO_REPORT = "ER0001";
		/**
		 * 商户风险信息查询
		 */
		public static final String RISK_INFO_QUERY = "QR0002";
	}
    ...
    public enum PCACMERCHANTTYPE {
        ...
        private PCACMERCHANTTYPE(String value, String label) {
            this.value = value;
            this.label = label;
        }
    ...
    public enum CORPORATEIDCODE {
        ...
        private CORPORATEIDCODE(String value, String label) {
            this.value = value;
            this.label = label;
        }
    ...
    public enum PERSONALIDCODE {
        ...
        private PERSONALIDCODE(String value, String label) {
            this.value = value;
            this.label = label;
        }
	...
	public interface PCACSystemCode{
		 ...
		 * 风险信息共享系统
		 */
		public static final String RISK_SHARE_SYSTEM = "R0001";
		/**
		 * 特约商户信息管理系统
		 */
		public static final String MERCHANT_INFO_MANAGE_SYSTEM = "SECB01";
		/**
		 * USERTOKEN参数
		 */
		public static final String USER_TOKEN_PARAM = "PCAC_USER_TOKEN";
	...
	public interface PCACMercRiskType{
		 ...
		 * 虚假申请
		 */
		public static final String FALSITY_APPLY = "01";
		/**
		 * 套现、套积分
		 */
		public static final String LIED_CASH_AND_INTEGRAL = "02";
		/**
		 * 违法经营
		 */
		public static final String UNLAWFUL_BUSINESS = "03";
		/**
		 * 销赃
		 */
		public static final String SELL_STOLEN_GOODS = "04";
		/**
		 * 买卖或租借银行（支付）账户
		 */
		public static final String BUY_AND_SELL_BANK_ACCOUNT = "05";
		/**
		 * 侧录点
		 */
		public static final String LATERAL_RECORDING_POINT = "06";
		/**
		 * 伪卡集中使用点
		 */
		public static final String PSEUDO_CARD_FOCUS_POINT  = "07";
		/**
		 * 泄露账户及交易信息
		 */
		public static final String DISCLOSE_ACCOUNT_AND_TRANS_INFO = "08";
		/**
		 * 09 ：恶意倒闭
		 */
		public static final String MALICIOUS_BANKRUPTCY = "09";
		/**
		 * 10：恶意分单
		 */
		public static final String MALICIOUS_ORDER = "10";
		/**
		 * 11 ：移机
		 */
		public static final String MOVE_POS = "11";
		/**
		 * 12 ：高风险商户
		 */
		public static final String HIGH_RISK_MERCHANT = "12";
		/**
		 * 13 ：商户合谋欺诈 
		 */
		public static final String COLLUSION_FRAUD = "13";
		/**
		 * 14 ：破产或停业商户
		 */
		public static final String BANKRUPT_OR_CLOSED_MERCHANT = "14";
		/**
		 * 15 ：强迫签单
		 */
		public static final String COMPULSORY_SIGNING = "15";
		/**
		 * 17：频繁变更服务机构
		 */
		public static final String FREQUENT_CHANGE_SERVICE_ORGAN = "17";
		/**
		 * 18：关联商户涉险
		 */
		public static final String RELATED_BUSINESSES_AT_RISK = "18";
		/**
		 * 19：买卖银行卡信息
		 */
		public static final String BUY_AND_SELL_BANK_CARD_INFO = "19";
		/**
		 * 20：拒刷信用卡
		 */
		public static final String BRUSH_OFF_CREDIT_CARD = "20";
		/**
		 * 21：转嫁手续费
		 */
		public static final String TRANSFER_COMMISSION = "21";
		/**
		 * 其它
		 */
		public static final String ONTEHR = "99";
	...
	public interface PCACMercRiskInfoChangeType{
		 ...
		 * 01：补录
		 */
		public static final String MAKEUP = "01";
		/**
		 * 02：失效
		 */
		 ...
		 * 03：降级
		 */
		public static final String DOWNGRADE = "03";
	}
	...
	public interface PCACRiskComeChannel{
		 ...
		 * 03：线上兼线下
		 */
		public static final String ONANDOFFLINE = "03";
	}
    ...
    public enum PCACMERCHANTATTRIBUTE {
        ...
        private PCACMERCHANTATTRIBUTE(String value, String label) {
            this.value = value;
            this.label = label;
        }
    ...
    public enum SETTLENETWORK {
        ...
        private SETTLENETWORK(String value, String label) {
            this.value = value;
            this.label = label;
        }
    ...
    public enum PCACMERCHANTSTATUS {
        ...
        private PCACMERCHANTSTATUS(String value, String label) {
            this.value = value;
            this.label = label;
        }
    ...
    public enum PCACOPERSERVICETYPE {
        ...
        private PCACOPERSERVICETYPE(String value, String label) {
            this.value = value;
            this.label = label;
        }
    ...
    public enum PCACBILLTYPE {
        ...
        private PCACBILLTYPE(String value, String label) {
            this.value = value;
            this.label = label;
        }
    ...
    public enum PCACSUPPORTACCOUNTTYPE {
        ...
        private PCACSUPPORTACCOUNTTYPE(String value, String label) {
            this.value = value;
            this.label = label;
        }
    ...
    public interface PCACEXPANDWAY{
		/**  01--自主拓展   */
		public static final String OWN_EXPAND = "01";
		/**  02--外包服务机构推荐   */
		public static final String OUT_EXPAND = "02";
	}
    ...
    public interface PCACRISKSTATUS{
    	/**  01--合规   */
    	public static final String QUALIFY = "01";
    	/**  02--风险   */
    ...
    public enum PCACUPLOADWAY {
        ...
        private PCACUPLOADWAY(String value, String label) {
            this.value = value;
            this.label = label;
        }
    ...
    public interface PCACCUSTOMERATTRIBUTE{
    	/**  01--个人   */
    	public static final String PERSIONAL = "01";
    	/**  02--商户   */
    ...
    public enum PCACResponseCodeEnum{
        ...
        private PCACResponseCodeEnum(String value, String label) {
            this.value = value;
            this.label = label;
        }
    ...
    public enum FTSTaskName{
    	...
    	private FTSTaskName(String value, String label) {
    		this.value = value;
    		this.label = label;
    	}
    	public String getValue() {
	...
	public interface RemitFileType {
		...
		public static final int PERY_DAY = 1;	
		
		/** 划付文件生成类型: 每个商户按照节假日汇总一笔划付文件  */
		public static final int HOLIDAY_MERGE = 2;
	}
