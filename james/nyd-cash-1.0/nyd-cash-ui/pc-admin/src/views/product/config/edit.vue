  ...
  <div class="form-container">
    <div class="page-bread">
      <el-breadcrumb separator="/">
        <el-breadcrumb-item :to="{ path: '/product/config' }">生产配置</el-breadcrumb-item>
    ...
    <div class="form-content">
      <el-form :model="form" :rules="rules" ref="form" label-width="120px" class="form-wraper">
        ...
        <el-form-item label="产地" prop="">
          <el-cascader v-model="form.modein" placeholder="搜索" :options="options" filterable change-on-select/>
        </el-form-item>
        <el-form-item label="销售区域码" prop="areaCode">
          <el-input v-model="form.salesCode"></el-input>
        </el-form-item>
