  ...
  export default {
    ...
    methods: {
      loadData: function () {
        ...
        Utils.ajax(Api.dictionary.warehouse.list, params, (success) => {
      ...
      add: function () {
        ...
        this.$router.push({path: '/dictionary/warehouse/add'});
      },
      edite: function (row) {
        sessionStorage.setItem("_factory",JSON.stringify(row));
        this.$router.push({path: '/dictionary/warehouse/edit/' + row.id});
      },
