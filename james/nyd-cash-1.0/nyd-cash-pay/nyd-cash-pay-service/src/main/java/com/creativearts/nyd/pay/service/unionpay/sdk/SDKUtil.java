...
import static com.creativearts.nyd.pay.service.unionpay.sdk.SDKConstants.*;
/**
 * 
 * @ClassName SDKUtil
...
//		System.out.println("*************6"+signMethod);
		String version = data.get(SDKConstants.param_version);
//		System.out.println("*************7"+version);
...
//		System.out.println(submitFromData.size()+"@@@@@@@@@@@@@");
//		System.out.println(JSON.toJSONString(submitFromData));
