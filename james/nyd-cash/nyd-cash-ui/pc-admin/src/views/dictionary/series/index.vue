  ...
  <div class="grid-container">
    ...
    <div class="grid-content">
      <el-table :data="tableData" v-loading.body="loading" stripe style="width: 100%">
        ...
        <el-table-column prop="rid" label="#" width="150"/>
  ...
  export default {
    ...
    methods: {
      loadData: function () {
        ...
        Utils.ajax(Api.dictionary.series.list, params, (success) => {
      ...
      add: function () {
        ...
        this.$router.push({path: '/dictionary/series/add'});
      },
      edite: function (row) {
        sessionStorage.setItem("_factory",JSON.stringify(row));
        this.$router.push({path: '/dictionary/series/edit/' + row.id});
      },
