    ...
    <div class="form-content">
      <el-form :model="form" :rules="rules" ref="form" label-width="120px" class="form-wraper">
        ...
        <el-form-item label="所属公司" prop="rid">
          <el-select v-model="form.rid" filterable placeholder="请选择" :remote-method="inputSearch">
            <el-option
  ...
  export default {
    ...
    methods: {
      submitForm(formName) {
        this.$refs[formName].validate((valid) => {
          if (valid) {
            ...
            Utils.ajax(Api.dictionary.brand.save, params, (success) => {
              //Dialog.alert();
            });
          } else {
            return false;
      ...
      inputSearch(obj){
        ...
        var params = {};
        let me = this.$data;
        Utils.ajax(Api.dictionary.factory.options, params, (success) => {
          me.options.company = success.data;
          alert(success.data);
        });
      }
