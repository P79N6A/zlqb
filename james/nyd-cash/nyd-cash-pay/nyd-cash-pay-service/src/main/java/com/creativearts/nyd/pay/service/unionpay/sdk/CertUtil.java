 ...
 * =============================================================================
 */
package com.creativearts.nyd.pay.service.unionpay.sdk;
...
import static com.creativearts.nyd.pay.service.unionpay.sdk.SDKConstants.UNIONPAY_CNNAME;
import static com.creativearts.nyd.pay.service.unionpay.sdk.SDKUtil.isEmpty;
/**
 * @ClassName: CertUtil
...
//			System.out.println("hahahahahahah====="+getSignCertId());
//			LogUtil.writeLog("InitSignCert Successful. CertId=["
//					+ getSignCertId() + "]");
		} catch (IOException e) {
			System.out.println("hahahahahahah=====exception");
	...
	public static String getSignCertId() {
		try {
			Enumeration<String> aliasenum = keyStore.aliases();
//			System.out.println("$$$$$$$$$"+JSON.toJSONString(aliasenum));
			String keyAlias = null;
			if (aliasenum.hasMoreElements()) {
				keyAlias = aliasenum.nextElement();
			}
			...
			System.out.println("$$$$$$$$$2$"+JSON.toJSONString(cert));
