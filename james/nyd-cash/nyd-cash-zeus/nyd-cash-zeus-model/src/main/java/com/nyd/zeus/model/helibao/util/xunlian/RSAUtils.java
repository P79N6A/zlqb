...
public final class RSAUtils {
    ...
    private static void test() {
        ...
        //明文
        byte[] ming = "123456789".getBytes(Base64Utils.UTF_8);
        System.out.println("明文：" + new String(ming, Base64Utils.UTF_8));
        //使用模和指数生成公钥和私钥
        ...
        System.out.println("密文：" + new String(mi,Base64Utils.UTF_8));
        //解密后的明文
        ming = RSAUtils.decryptByPrivateKey(mi, priKey);
        System.out.println("解密：" + new String(ming, Base64Utils.UTF_8));
    }
    ...
    public static void main(String[] args) throws Exception {
        ...
        //明文
        byte[] ming = "这是一段测试文字。。。。".getBytes(Base64Utils.UTF_8);
        System.out.println("明文:" + new String(ming, Base64Utils.UTF_8));

        //加密后的密文
        byte[] mi = RSAUtils.encryptByPublicKey(ming, publicKey);
        String miString = Base64Utils.encode(mi);
        System.out.println("密文:" + miString);
//        System.out.println("密文:" + new String(mi, Base64Utils.UTF_8));
        
        //解密后的明文
        byte[] decodeByte = RSAUtils.decryptByPrivateKey(Base64Utils.decode(miString), privateKey);
        String mingStr = new String(decodeByte, Base64Utils.UTF_8);
        System.out.println("\n解密:" + mingStr);
//        ming = RSAUtils.decryptByPrivateKey(mi, privateKey);   
//      System.out.println("\n解密:" + new String(ming, Base64Utils.UTF_8));
