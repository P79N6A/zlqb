...
public final class StatusConstants {
	...
	public static final String BANK_BIND_MOBILE_EXIST_MSG = "手机号码已被注册";
	...
	public static final String	ORDER_CREATE_NO_MSG = "该用户存在未结清订单或审批中订单，暂不能借款";
	...
	public static final String USER_BLACKLIST_APPLY_CODE = "B00060";
	public static final String USER_BLACKLIST_APPLY_MSG = "您不符合进件条件，无法申请";
	
	public static final String BANK_MOBILE_CODE_ERROR_CODE = "B00061";
	public static final String BANK_MOBILE_CODE_ERROR_MSG = "获取验证码失败，请重新尝试";
	
	public static final String  ORDER_REPAYMENT_EXIST = "B0063";
	public static final String	ORDER_REPAYMENT_EXIST_MSG = "存在还款中订单，请结清后再申请";
	
	
	public static final String  CUST_COUNT_OVER = "B0064";
	public static final String	CUST_COUNT_OVER_MSG = "今日认证次数已达上限，请明日再试";
	
	public static final String  CUSTORDER_REFUSE = "B0065";
	public static final String	CUSTORDER_REFUSE_MSG = "您借款申请未能通过，请努力提升您的信用吧";
	...
	public static final String ORDER_APPLY_REPAYMENT_RELIEF_AMOUNT_ERROR = "D0034";
	public static final String ORDER_APPLY_REPAYMENT_RELIEF_AMOUNT_ERROR_MSG = "订单减免金额不可以大于剩余应还金额，无法还款。";
	
	public static final String ORDER_APPLY_COUNT_OVERRUN_CODE = "D0035";
	public static final String ORDER_APPLY_COUNT_OVERRUN_MSG = "您已达到最高续贷次数，无法继续申请。";
	static {
	...
	public static final String AMOUNTINITIAL_AMOUNTMIN_ERROR = "E0026";
	public static final String AMOUNTINITIAL_AMOUNTMIN_ERROR_MSG ="金额初始值不能小于金额最小值";
	
	public static final String AMOUNTSCALE_INITIA_ERROR = "E0027";
	public static final String AMOUNTSCALE_INITIA_ERROR_MSG ="金额刻度值不能大于金额最大值与金额初始值之差";
