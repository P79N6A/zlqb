	...
	export default {
	  	...
	  	methods: {
		    ...
		    handTransfer:function(rows){
		    	this.$router.push({ path: '/instorage_action/sales_returns_warehousing/hand/'+rows.id });
		    },
		    goDetail:function(rows){
		    	this.$router.push({ path: '/instorage_action/sales_returns_warehousing/detail/'+rows.id });
		    }
	    }
	}
</script>
