...
categories.forEach(category => {
  let root = {};
  root.path = "/" + category.module + "/";
  root.component = (resolve => require(['@/'+ views + root.path + 'index'], resolve))
  root.redirect = root.path + "index";
  root.children = [{
    path: root.path + 'index',
    component: resolve => require(['@/'+ views  + root.path + "dashboard"], resolve)
  }];

  if (category.sub) {
    category.sub.forEach(feature => {
      let menu= {};
      menu.path= root.path + feature.id + "/";
      menu.component = resolve => require(['@/'+ views  + menu.path +'index'], resolve)
      root.children.push(menu);
      if (feature.actions) {
        $.each(feature.actions,function(k,v){
          let actions = {
            path:menu.path+ k,
            component : resolve => require(['@/'+ views  + menu.path + v], resolve)
          };
          if('edit' == k){
            actions.path = menu.path+ k + "/:id"
          }
          root.children.push(actions);
        });
      }
    })
  }
  menus.children.push(root);
})
routes.push(menus)
  ...
  routes: [
    {
      ...
      children: [
        ...
        },
        {
          ...
          path: '/dictionary',
          name: '数据字典',
          component: resolve => require(['@/views/dictionary/index'], resolve),
          redirect: '/dictionary/index',
          children: [
            {
              path: "/dictionary/index",
              component: {
                template: "<p>dictionary index</p>"
              }
            }, {
              path: "/dictionary/factory",
              component: resolve => require(['@/components/dictionary/factory/index'], resolve)
            }, {
              path: "/dictionary/factory/add",
              name: "新增工厂",
              component: resolve => require(['@/components/dictionary/factory/edit'], resolve)
            }, {
              path: "/dictionary/factory/edit/:id",
              name: "编辑工厂",
              component: resolve => require(['@/components/dictionary/factory/edit'], resolve)
            }, {
              path: "/dictionary/brand",
              component: resolve => require(['@/components/dictionary/brand/index'], resolve)
            }, {
              path: "/dictionary/brand/add",
              name: "新增品牌",
              component: resolve => require(['@/components/dictionary/factory/edit'], resolve)
            }, {
              path: "/dictionary/brand/edit/:id",
              name: "编辑品牌",
              component: resolve => require(['@/components/dictionary/factory/edit'], resolve)
            }, {
              path: "/dictionary/series",
              component: resolve => require(['@/components/dictionary/series/index'], resolve)
            }, {
              path: "/dictionary/model",
              component: resolve => require(['@/components/dictionary/model/index'], resolve)
            }, {
              path: "/dictionary/warehouse",
              component: resolve => require(['@/components/dictionary/warehouse/index'], resolve)
            }
          ]
        }, {
          path: '/sys_setting',
          ...
          children: [
            {
              ...
              component: {
                template: "<p>reservoir_dictionary阿斯顿撒大苏打似的</p>"
              }
            }, {
